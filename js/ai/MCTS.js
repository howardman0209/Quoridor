export const MCTS = (() => {
    return {
        monteCarloTreeSearch: function (rootNode, simulationFunction, iterations) {
            for (let i = 0; i < iterations; i++) {
                ...
                let score = simulationFunction(newNode.state);
        ...
        backpropagation: function (node, score) {
